...
public class MazeGenerator : MonoBehaviour
{
	...
	[SerializeField] private int enemyCount = 5; // сколько врагов появится
	[SerializeField] private int type1Weight = 1;
	[SerializeField] private int type2Weight = 3;
	// Для новых типов просто добавляй новые поля
	...
	void SpawnEnemies()
	{
		...
		// Соотношение 1:2 (первый тип : второй тип)
